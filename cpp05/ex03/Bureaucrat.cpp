...
/*   Updated: 2024/11/11 13:38:20 by danevans         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::executeForm(AForm const & form){
	try{
		...
		std::cerr << " unable to execute the form sorry " << std::endl;
		throw;
	} catch (const AForm::NotSignedException &notsigned){
		std::cerr << notsigned.what() << std::endl;
		std::cerr << "unable to execute the form sorry " << std::endl;
		throw; 
	}
}
